...
from src.data.tree_similarity import TreeSimilarity
...
class OntologyTree():
    def __init__(self, dataset_name_or_path, tree_ratio):
        ...
        elif dataset_name_or_path in ["AAP", "cometa_knn_clinical"]:
            df = pd.read_csv("./data/ontology/snomed_tree_code_201907.csv")
        elif dataset_name_or_path in ['ispo']:
            df = pd.read_excel("./data/ontology/ISPO_Tree_BioSyn.xlsx")
        else:
